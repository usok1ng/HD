...
final class CoordinatorPointCloud: MTKCoordinator {
    ...
    init(mtkView: MTKView, arData: ARProvider, confSelection: Binding<Int>, scaleMovement: Binding<Float>, minDepth: Binding<Float>, maxDepth: Binding<Float>) {
        self.arData = arData
...
//        staticAngle += staticInc
    ...
    override func draw(in view: MTKView) {
        ...
        encoder.setVertexTexture(arData.colorRGBContent.texture, index: 2)
...
struct MetalPointCloud: UIViewRepresentable {
    ...
    func makeCoordinator() -> CoordinatorPointCloud {
        return CoordinatorPointCloud( mtkView: mtkView, arData: arData, confSelection: $confSelection, scaleMovement: $scaleMovement, minDepth: $minDepth, maxDepth: $maxDepth)
    }
